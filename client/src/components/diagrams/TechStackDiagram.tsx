...
const layers: Layer[] = [
  ...
  },
  {
    ...
    tech: "R&D · HeyGem OS (transition) · Exoscale GPU",
    techFr: "R&D · HeyGem OS (transition) · GPU Exoscale",
    latency: "<500ms (target)",
    status: "rd",
    sovereign: true,
    tooltip: "Main bottleneck. Currently 5–10s with HeyGem OS. R&D target: <500ms via distillation + streaming diffusion + intelligent cache.",
    tooltipFr: "Goulot principal. Actuellement 5–10s avec HeyGem OS. Cible R&D : <500ms via distillation + diffusion streaming + cache intelligent.",
  },
  {
    id: "tts",
