...
const gaps: GapPoint[] = [
  ...
  },
  {
    ...
    description: "Current LLMs lose context after ~8k tokens. GamiWays requires coherence over 1h+ sessions and across multiple sessions (days/weeks). A 3-layer memory architecture (working / episodic / semantic) with RAG retrieval is the proposed solution.",
    descriptionFr: "Les LLMs actuels perdent le contexte après ~8k tokens. GamiWays exige une cohérence sur des sessions 1h+ et sur plusieurs sessions (jours/semaines). Une architecture mémoire 3 couches (working / épisodique / sémantique) avec récupération RAG est la solution proposée.",
  ...
  },
  {
    ...
    description: "Existing TTS (ElevenLabs, Coqui, StyleTTS2) can clone a voice timbre but not its prosodic fingerprint: individual rhythm, pause patterns, emphasis style. GamiWays needs to reproduce how a specific person speaks, not just their voice.",
    descriptionFr: "Les TTS existants (ElevenLabs, Coqui, StyleTTS2) peuvent cloner un timbre vocal mais pas son empreinte prosodique : rythme individuel, patterns de pauses, style d'emphase. GamiWays doit reproduire comment une personne spécifique parle, pas seulement sa voix.",
  ...
  },
  {
    ...
    description: "No existing framework combines deterministic narrative control (scripted sequences, pedagogical constraints) with organic LLM-driven conversation. GamiWays needs a continuum 0–100% between full script and full improvisation, manageable by non-technical creators.",
    descriptionFr: "Aucun framework existant ne combine contrôle narratif déterministe (séquences scriptées, contraintes pédagogiques) avec conversation organique pilotée par LLM. GamiWays a besoin d'un continuum 0–100% entre script complet et improvisation totale, gérable par des créateurs non techniques.",
  ...
  },
  {
    ...
    description: "GamiWays requires synchronization of 5 simultaneous streams (video avatar, voice, subtitles, quiz overlays, chapter markers) with <100ms drift. Memoways' 14 years of multimedia experience provides a strong foundation; this is internal R&D, not academic research.",
    descriptionFr: "GamiWays exige la synchronisation de 5 flux simultanés (vidéo avatar, voix, sous-titres, overlays quiz, marqueurs de chapitre) avec une dérive <100ms. Les 14 ans d'expérience multimédia de Memoways fournissent une base solide ; c'est de la R&D interne, pas de la recherche académique.",
