...
const sttDatabase: STTData[] = [
  ...
  },
  {
    ...
    category: "cloud-api",
    tagline: "Chirp 3 GA (mai 2026) — 125 langues, WER 2.7%, MedASR, offline expansion",
    homepageUrl: "https://cloud.google.com/speech-to-text",
    docsUrl: "https://cloud.google.com/speech-to-text/docs",
    wer: 2.7,
    werNote: "2.7% WER English (Chirp 3, Artificial Analysis mai 2026). Chirp 2: 6.8% WER. 125+ langues avec Chirp 3.",
    latencyMs: 200,
    latencyMsTypical: 650,
    architecture: "Chirp 3 (USM — Universal Speech Model, 2B+ params, GA mai 2026)",
    params: "2B+ (USM Chirp 3)",
    license: "Commercial",
    selfHostable: false,
    selfHostNote: "Cloud only (GCP). No on-premise.",
    pricePerHour: 0.36,
    pricePerMin: 0.006,
    priceNote: "$0.016/min (Chirp 3, 0–500k min). $0.006/min (Chirp 2). $0.004/min (standard). Free: 60 min/month.",
    ...
    description: "Google Speech-to-Text v2 avec Chirp 3 (GA mai 2026) : 2.7% WER EN (Artificial Analysis), 125+ langues, streaming gRPC bidirectionnel. MedASR open-source lancé fin 2025 (domaine médical). Expansion offline majeure (avril 2026). Pas de clonage vocal natif (via Google TTS séparé). RAG via tool calling + Vertex AI Search. Cloud uniquement, pas d'on-premise.",
    descriptionFr: "Google Speech-to-Text v2 avec Chirp 3 (GA mai 2026) : 2,7% WER EN (Artificial Analysis), 125+ langues, streaming gRPC bidirectionnel. MedASR open-source lancé fin 2025 (domaine médical). Expansion offline majeure (avril 2026). Pas de clonage vocal natif (via Google TTS séparé). RAG via tool calling + Vertex AI Search. Cloud uniquement, pas d'on-premise.",
    strengths: ["2.7% WER (Chirp 3, mai 2026) — meilleure précision cloud", "125+ langues — couverture la plus large", "EU data residency available", "gRPC streaming bidirectionnel", "MedASR open-source (domaine médical)", "Google ecosystem integration (Dialogflow, Vertex AI)"],
    ...
    dataUpdateNote: "Chirp 3 GA mai 2026 : WER 2.7% EN (Artificial Analysis), 125+ langues. Prix $0.016/min (Chirp 3). MedASR open-source lancé fin 2025. Expansion offline majeure avril 2026. Clonage vocal : NON natif. RAG : via tool calling + Vertex AI Search.",
    sources: [
      { label: "Google STT Pricing", url: "https://cloud.google.com/speech-to-text/pricing", type: "pricing" },
      { label: "Google Chirp 3 GA (mai 2026)", url: "https://cloud.google.com/blog/products/ai-machine-learning/google-cloud-chirp-3-speech-to-text", type: "news" },
      { label: "Google STT Docs", url: "https://cloud.google.com/speech-to-text/docs", type: "docs" },
      { label: "Artificial Analysis STT Benchmarks", url: "https://artificialanalysis.ai/speech-to-text", type: "benchmark" },
      { label: "Google STT Release Notes", url: "https://cloud.google.com/speech-to-text/docs/release-notes", type: "docs" },
    ],
  },
  {
    id: "azure-stt",
    ...
    dataUpdatedAt: "2026-05-03",
    dataUpdateNote: "Azure Speech mai 2026 : $1/hr standard, $0.18/hr batch, $1.50/hr custom model. WER 5.9% EN (Artificial Analysis). LLM Speech (preview) : STT+LLM intégré. Fast Transcription API (2024-11-15). Clonage vocal NATIF via Custom Voice ($24/1M chars). RAG via Azure AI Search + VoiceRAG pattern. Datacenter Suisse (Switzerland North, Zurich) confirmé. Conteneur déconnecté disponible.",
    sources: [
      ...
      { label: "Artificial Analysis STT Azure", url: "https://artificialanalysis.ai/speech-to-text/models/azure", type: "benchmark" },
      { label: "VoiceRAG Pattern (Azure AI Search)", url: "https://techcommunity.microsoft.com/blog/azure-ai-foundry-blog/voicerag-an-app-pattern-for-rag--voice-using-azure-ai-search-and-the-gpt-4o-real/4259116", type: "docs" },
      { label: "Azure LLM Speech Preview", url: "https://learn.microsoft.com/en-us/azure/ai-services/speech-service/overview", type: "news" },
    ],
  },
  // ─── OPEN SOURCE ─────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    benchmarkRef: "Artificial Analysis STT mai 2026 + Mistral AI docs",
    dataUpdatedAt: "2026-05-03",
    dataUpdateNote: "Voxtral ASR (Mistral-v0.1) : WER 8.72% EN (Artificial Analysis mai 2026, #7 classement). API Mistral : $0.001/min (STT seul). Apache 2.0 open-weights. Modèle disponible sur HuggingFace. Stack complet : Voxtral ASR → Mistral LLM → Voxtral TTS. Clonage vocal : NON natif (Voxtral TTS propose adaptation de voix). RAG : via function calling Mistral API.",
    sources: [
      ...
      { label: "Artificial Analysis STT Benchmarks", url: "https://artificialanalysis.ai/speech-to-text", type: "benchmark" },
      { label: "Voxtral HuggingFace", url: "https://huggingface.co/mistralai/Voxtral-S-22B-2507", type: "docs" },
    ],
  },
  // ─── INWORLD STT ─────────────────────────────────────────────
  {
