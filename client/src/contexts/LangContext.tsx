/*
 * LangContext — i18n EN/FR for GamiWays Research Portal
...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "home.desc": "This portal documents the fundamental research challenges for the GamiWays project: real-time latency, conversational memory, and behavioral fidelity.",
    ...
    "home.pipeline.desc": "Each exchange passes through 6 stages — avatar generation is the main bottleneck (5–10s currently, target 500ms).",
    "home.gap.label": "THE GAP",
    "home.gap.title": "Why This Research?",
    "home.gap.body": "Current avatar platforms (HeyGen, Synthesia) produce high-quality video but with 6–12 second latency per exchange — incompatible with natural conversation. Real-time solutions (NVIDIA ACE, Beyond Presence) require proprietary infrastructure and do not allow behavioral personalization from existing archives. GamiWays aims to bridge this gap: sovereign, open, personalized, and real-time.",
    "home.gap.challenge": "The fundamental challenge: achieve a 6–10× latency reduction while preserving behavioral fidelity of the specific person — a problem at the intersection of speech processing, computer vision, NLP, and systems engineering.",
    ...
    "project.s2.subtitle": "GamiWays serves two markets through a shared technical core.",
    ...
    "project.mode01": "MODE 01 — PEDAGOGICAL",
    ...
    "project.mode02": "MODE 02 — NARRATIVE",
    ...
    "project.analogy": "Analogy: HeyGen/Synthesia = iMovie (simple, limited). Flowise + custom = Final Cut XML (powerful, complex). GamiWays = Final Cut Pro (powerful AND usable by non-technical creators).",

    // Research page
    "research.label": "02 — RESEARCH CHALLENGES",
    "research.title": "Research Challenges",
    "research.subtitle": "Fundamental research axes for the GamiWays project",
    "research.intro": "The GamiWays project raises fundamental research questions at the intersection of several disciplines. These challenges are not mere engineering problems — they require advances in basic research to be solved. This document presents the three main axes identified of the research program.",
    ...
    "research.current": "CURRENT STATE — 6–12 seconds",
    ...
    "sota.intro": "This analysis covers the landscape of existing solutions in the fields relevant to GamiWays: conversational avatar platforms, speech synthesis, conversational memory, and real-time orchestration. The goal is to identify where the state of the art stands, what is missing, and where fundamental research can make a difference.",
    "sota.s1.number": "01",
    "sota.s1.title": "Tools & Platforms Comparison",
    "sota.s1.subtitle": "Evaluation of existing solutions on key criteria for GamiWays.",
    "sota.s2.number": "02",
    ...
    "sota.s3.subtitle": "What is missing, what exists, and where GamiWays can contribute.",
    "sota.s4.number": "04",
    ...
    "sota.s6.subtitle": "Recommended technology stack for GamiWays.",
    ...
    "sota.validity.body": "The analysis confirms the scientific interest of the GamiWays project. No existing solution combines all five required properties: real-time (<2s), behavioral personalization, sovereignty, conversational memory, and accessibility for non-technical creators. This combination represents a genuine research frontier.",
  },
  ...
  fr: {
    ...
    "home.desc": "Ce portail documente les défis de recherche fondamentale pour la projet GamiWays : latence temps réel, mémoire conversationnelle et fidélité comportementale des avatars vidéo personnalisés.",
    ...
    "home.pipeline.desc": "Chaque échange passe par 6 étapes — la génération d'avatar est le goulot d'étranglement principal (5–10s actuellement, cible 500ms).",
    "home.gap.label": "LE GAP",
    "home.gap.title": "Pourquoi cette recherche ?",
    "home.gap.body": "Les plateformes d'avatars actuelles (HeyGen, Synthesia) produisent des vidéos de haute qualité mais avec 6–12 secondes de latence par échange — incompatible avec une conversation naturelle. Les solutions temps réel (NVIDIA ACE, Beyond Presence) nécessitent une infrastructure propriétaire et ne permettent pas la personnalisation comportementale depuis des archives existantes. GamiWays vise à combler ce gap : souverain, ouvert, personnalisé, et temps réel.",
    "home.gap.challenge": "Le défi fondamental : atteindre une réduction de latence de 6–10× tout en préservant la fidélité comportementale de la personne spécifique — un problème à l'intersection du traitement de la parole, de la vision par ordinateur, du NLP et de l'ingénierie des systèmes.",
    ...
    "project.intro": "GamiWays est une plateforme de création d'expériences conversationnelles interactives avec avatars vidéo — combinant dialogue IA temps réel, génération d'avatar photorealistic et séquençage cinématographique intelligent. La plateforme est conçue pour les créateurs de contenu, éducateurs et conteurs qui souhaitent créer des expériences immersives sans nécessiter d'expertise technique.",
    "project.s1.number": "01",
    ...
    "project.s2.subtitle": "GamiWays sert deux marchés via un cœur technique partagé.",
    "project.s3.number": "03",
    ...
    "project.mode01": "MODE 01 — PÉDAGOGIQUE",
    ...
    "project.mode02": "MODE 02 — NARRATIF",
    ...
    "project.analogy": "Analogie : HeyGen/Synthesia = iMovie (simple, limité). Flowise + custom = Final Cut XML (puissant, complexe). GamiWays = Final Cut Pro (puissant ET utilisable par des créateurs non-techniques).",

    // Research page
    "research.label": "02 — DÉFIS DE RECHERCHE",
    "research.title": "Défis de Recherche",
    "research.subtitle": "Axes de recherche fondamentale du projet GamiWays",
    "research.intro": "Le projet GamiWays soulève des questions de recherche fondamentale à l'intersection de plusieurs disciplines. Ces défis ne sont pas de simples problèmes d'ingénierie — ils nécessitent des avancées en recherche fondamentale pour être résolus. Ce document présente les trois axes principaux identifiés du programme de recherche.",
    "research.s1.number": "01",
    ...
    "research.current": "ÉTAT ACTUEL — 6–12 secondes",
    ...
    "sota.intro": "Cette analyse couvre le paysage des solutions existantes dans les domaines pertinents pour GamiWays : plateformes d'avatars conversationnels, synthèse vocale, mémoire conversationnelle, et orchestration temps réel. L'objectif est d'identifier où en est l'état de l'art, ce qui manque, et où la recherche fondamentale peut faire une différence.",
    "sota.s1.number": "01",
    "sota.s1.title": "Comparatif des Outils & Plateformes",
    "sota.s1.subtitle": "Évaluation des solutions existantes sur les critères clés pour GamiWays.",
    "sota.s2.number": "02",
    ...
    "sota.s3.subtitle": "Ce qui manque, ce qui existe, et où GamiWays peut contribuer.",
    "sota.s4.number": "04",
    ...
    "sota.s6.subtitle": "Stack technologique recommandée pour GamiWays.",
