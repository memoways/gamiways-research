...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "home.gap.body": "Current avatar platforms (HeyGen, Synthesia) produce high-quality video but with 6–12 second latency per exchange — incompatible with natural conversation. Real-time solutions (NVIDIA ACE, Beyond Presence) require proprietary infrastructure and do not allow behavioral personalization from existing archives. DigiDouble aims to bridge this gap: sovereign, open, personalized, and real-time.",
